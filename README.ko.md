...
>
> 🇺🇸 [English README](./README.md) · 함께 쓰는 런타임: [ThisCode](https://github.com/treylom/ThisCode) (Claude Code 쪽) · 📖 [시작 안내서 (한국어 PDF, 초보자, 14p)](docs/getting-started/ThisCode-ThisCodex-getting-started.pdf) · 본 레포 = **Codex 쪽** + 두 런타임 공통 규칙.
