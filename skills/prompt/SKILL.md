...
| Build Codex bot meta file (canonical AGENTS.md + SOUL v2 capsule) | [`references/instructions/Bot-Persona-Generator.md`](references/instructions/Bot-Persona-Generator.md) |
...
| Build bot persona/meta file | `/prompt bot-persona: <role> <scope> <discord>` — generates one canonical Codex `AGENTS.md` with its SOUL v2 capsule using the Bot-Persona-Generator framework (used by guided onboarding). |
